...
class HomePage:
    ...
    def preview_skin(self, skin_name):
        ...
        # 这里应该加载和显示皮肤动画
        ttk.Label(preview_window, text=f"正在预览: {skin_name}", 
                 font=('Arial', 14), background='#ecf0f1').pack(pady=20)
        
        # 模拟预览区域
        preview_area = ttk.Frame(preview_window, width=200, height=200, 
        ...
        ttk.Button(preview_window, text="关闭", style='Action.TButton',
    ...
    def buy_skin(self, skin_name):
        ...
        ttk.Label(buy_window, text=f"确定购买 {skin_name} 吗?", 
                 font=('Arial', 14), background='#ecf0f1').pack(pady=20)
        ttk.Label(buy_window, text="价格: 100金币", background='#ecf0f1').pack(pady=10)
        
        btn_frame = ttk.Frame(buy_window, style='Content.TFrame')
    ...
    def create_chatroom(self):
        ...
        self.center_window(create_window, 350, 250)  # 居中窗口
        
        ttk.Label(create_window, text="聊天室名称:", background='#ecf0f1').pack(pady=10)
        name_entry = ttk.Entry(create_window, width=25)
        name_entry.pack(pady=5)
        
        ttk.Label(create_window, text="密码(可选):", background='#ecf0f1').pack(pady=10)
        password_entry = ttk.Entry(create_window, width=25, show="*")
        password_entry.pack(pady=5)
        
        btn_frame = ttk.Frame(create_window, style='Content.TFrame')
        btn_frame.pack(pady=10)
    ...
    def show_login(self):
        ...
        self.center_window(login_window, 350, 280)  # 居中窗口
        
        ttk.Label(login_window, text="用户名:", background='#ecf0f1').pack(pady=10)
        username_entry = ttk.Entry(login_window, width=25)
        username_entry.pack(pady=5)
        
        ttk.Label(login_window, text="密码:", background='#ecf0f1').pack(pady=10)
        password_entry = ttk.Entry(login_window, width=25, show="*")
        password_entry.pack(pady=5)
        
        btn_frame = ttk.Frame(login_window, style='Content.TFrame')
    ...
    def show_register(self):
        ...
        register_window.geometry("350x330")
        register_window.configure(bg='#ecf0f1')
        self.center_window(register_window, 350, 330)  # 居中窗口
        
        ttk.Label(register_window, text="用户名:", background='#ecf0f1').pack(pady=10)
        username_entry = ttk.Entry(register_window, width=25)
        username_entry.pack(pady=5)
        
        ttk.Label(register_window, text="密码:", background='#ecf0f1').pack(pady=10)
        password_entry = ttk.Entry(register_window, width=25, show="*")
        password_entry.pack(pady=5)
        
        ttk.Label(register_window, text="确认密码:", background='#ecf0f1').pack(pady=10)
        confirm_password_entry = ttk.Entry(register_window, width=25, show="*")
        confirm_password_entry.pack(pady=5)
        
        btn_frame = ttk.Frame(register_window, style='Content.TFrame')
        btn_frame.pack(pady=15)
