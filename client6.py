...
class HomePage:
    ...
    def show_marketplace(self):
        ...
        for i, skin in enumerate(skins):
            ...
            skin_frame.columnconfigure(0, weight=1)  # 让皮肤框架内的列均匀分布
    ...
    def create_chatroom(self):
        ...
        # 使用Grid布局让标签和输入框在同一行
        ttk.Label(create_window, text="聊天室名称:", background='#ecf0f1').grid(row=0, column=0, padx=10, pady=10, sticky='e')
        name_entry = ttk.Entry(create_window, width=20)
        name_entry.grid(row=0, column=1, padx=10, pady=10, sticky='w')
        
        ttk.Label(create_window, text="密码(可选):", background='#ecf0f1').grid(row=1, column=0, padx=10, pady=10, sticky='e')
        password_entry = ttk.Entry(create_window, width=20, show="*")
    ...
    def show_login(self):
        ...
        # 使用Grid布局让标签和输入框在同一行
        ttk.Label(login_window, text="用户名:", background='#ecf0f1').grid(row=0, column=0, padx=10, pady=10, sticky='e')
        username_entry = ttk.Entry(login_window, width=20)
        username_entry.grid(row=0, column=1, padx=10, pady=10, sticky='w')
        
        ttk.Label(login_window, text="密码:", background='#ecf0f1').grid(row=1, column=0, padx=10, pady=10, sticky='e')
    ...
    def show_register(self):
        ...
        # 使用Grid布局让标签和输入框在同一行
        ttk.Label(register_window, text="用户名:", background='#ecf0f1').grid(row=0, column=0, padx=10, pady=10, sticky='e')
        username_entry = ttk.Entry(register_window, width=20)
        username_entry.grid(row=0, column=1, padx=10, pady=10, sticky='w')
        
        ttk.Label(register_window, text="密码:", background='#ecf0f1').grid(row=1, column=0, padx=10, pady=10, sticky='e')
        password_entry = ttk.Entry(register_window, width=20, show="*")
        password_entry.grid(row=1, column=1, padx=10, pady=10, sticky='w')
        
        ttk.Label(register_window, text="确认密码:", background='#ecf0f1').grid(row=2, column=0, padx=10, pady=10, sticky='e')
        confirm_password_entry = ttk.Entry(register_window, width=20, show="*")
